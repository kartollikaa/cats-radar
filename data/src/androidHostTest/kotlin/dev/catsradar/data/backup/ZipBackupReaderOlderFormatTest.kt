    ...
    fun anArchiveFromBeforeShotsReadsEveryPhotoAsStartingItsOwnShot() = runTest {
        listOf(FORMAT_FOUR_MANIFEST, FORMAT_FIVE_MANIFEST).forEach { manifest ->
            ...
            path.writeArchive(
                ...
                ENCOUNTERS_ENTRY to """[{"id":"a","occurredAt":0,"tzOffsetMinutes":0,"kind":"PHOTO",""" +
                    """"origin":"CAMERA","locationSource":"NONE","deviceId":"d","createdAt":0,"updatedAt":0}]""",
                ENCOUNTER_PHOTOS_ENTRY to """[{"id":"p","encounterId":"a","photoPath":"p.jpg",""" +
                    """"deviceId":"photo-install",""" +
                    """"addedAt":7,"thumbPath":"p_thumb.jpg",""" +
            ...
            assertIs<BackupReadResult.Readable>(read, manifest)
            assertEquals(
                listOf(
                    EncounterPhoto(
                        id = "p",

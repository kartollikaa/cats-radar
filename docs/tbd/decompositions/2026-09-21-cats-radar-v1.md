...
| 24b | Walking mode as a Live Update | Promote the ongoing notification on API 36+ so it reaches the status-bar chip and always-on display; ordinary ongoing notification below that. | safe | ~200 | 24 | in-review |
